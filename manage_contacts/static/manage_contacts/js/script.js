...
window.addEventListener('load', (event) => {
  ...
  buildTable(url="get-contact-data", tableID="contact-table", filterQuery='', checkWidget=true);
  ...
  // buildTable(url="get-contact-data", tableID="contact-table", filterQuery=filterQuery, checkWidget=true);
  // })
